  ...
  try {
    ...
    if (existing === 0) {
      try {
        ...
        // On read-only filesystems (e.g. Vercel serverless), seeding at runtime
        // fails silently — data was already seeded at build time. Fall through
        // to return whatever counts exist.
      }
    }
